...
ext_raster <- raster::raster(ext_dbbmm, res = 25) # resolution in m
...
#                        "all_home_ranges_wAKDE_young_old_20230529.",
#                        filetypes[i]),
#        width = 160,
#        height = 125,
#        units = "mm",
...
all_contours_95_df %>% ggplot(aes(Age, UD95_area_km2)) +
  ...
  labs(y = expression(paste("AKDE UD95 Area   ", (km^2)))) +
  theme_classic()
...
sexplot <- all_contours_95_df %>% ggplot(aes(Sex, UD95_area_km2)) +
  ...
  geom_jitter(width = 0.15, size = 3, alpha = 0.5) +
  labs(y = expression(paste("AKDE UD95 Area   ", (km^2)))) +
  theme_classic()
...
area_age_glm_plot <- effect_plot(area_age_glm, 
  ...
  ylab(expression(UD[95]~area~(km^2))) +
  theme_classic() +
...
all_contours_95_df %>% ggplot(aes(x = age, y = outside)) +
  ...
  scale_y_continuous(breaks = seq(0,1,0.2), limits = c(0,1), 
                     "Proportion of UD Outside of Orokonui Ecosanctaury") +
  theme_classic() +
  theme(axis.title.y = element_text(margin = margin(r = 10)))
...
outsideglmplot <- effect_plot(outsideglm, 
                              ...
                              point.alpha = 0.5) +
  scale_x_continuous(breaks = c(1:10)) +
  labs(x = "Age", y = "Proportion of UD Outside of Orokonui") +
  theme_classic() +
  theme(axis.title.y = element_text(margin = margin(r = 10)))
...
# for(i in 1:length(filetypes)) {
# ggsave(filename = paste0("Graphical outputs/",
#                        "age_area_overlap_glms_20230529.",
#                        filetypes[i]),
#        width = 160,
#        height = 75,
#        units = "mm",
